**فرض کنید ما ۴ سیگنال آغشته به نویز داشته باشیم. با استفاده از روش‌های حذف نویز median و فیلتر Ensemble averaging، مقدار SNR (نسبت سیگنال به نویز) را محاسبه کنید.**
...
برای حل سوال، باید از داده‌های موجود در جدول و فرمول SNR استفاده کنیم. هدف محاسبه مقدار **SNR** برای سیگنال‌های نویزدار با استفاده از دو روش مختلف — **Median Filter** و **Ensemble Averaging** — است.
